		...
		<tfoot>
			...
			<tr>
				<td id='cart-widget-links' colspan="5">
					<a target="_parent" href="<?php echo esc_url( get_option( 'shopping_cart_url' ) ); ?>" title="<?php esc_html_e('Checkout', 'wpsc'); ?>" class="gocheckout"><img src="http://www.organickidsla.com/wp-content/themes/OrganicKids/images/Checkout_Btn.png" alt="checkout"></a>
