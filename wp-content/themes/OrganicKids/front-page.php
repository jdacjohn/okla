...
if ( 'posts' == get_option( 'show_on_front' ) && $responsive_options['front_page'] != 1 ) {
	...
	<div id="TaglineHome" class="grid col-940"><img src="http://www.organickidsla.com/wp-content/themes/OrganicKids/images/leafDivider.png" width="13" height="13" alt="LeafDivider">&nbsp;From the Farm to the Lunch Table&nbsp;<img src="http://www.organickidsla.com/wp-content/themes/OrganicKids/images/leafDivider.png" width="13" height="13" alt="LeafDivider"></div>
